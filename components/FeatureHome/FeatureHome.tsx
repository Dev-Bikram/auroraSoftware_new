  ...
  return (
    <FeatureWrap id="homeFeature-sec">
        <Box className="common-gap">
            <Container>
                <CommonHeadingTittle tittletxt="Features" subTxt="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book" />
                    ...
                    <Box className="maininnr-wrap-feature">
                        <Box className="commonclmfetr left-feature-txtwrap">
                            ...
                            <Box className="single-wraptxtLft">
                                <i><Image src={item.iconimg} width={26} height={26} alt='icon'/></i>
                                <Typography variant='h3'>{item.tittletxt}</Typography>
                                <Typography variant='body1'>{item.subtxtttl}</Typography>
                            </Box>
                            ))}
                        </Box>
